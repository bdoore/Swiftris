...
//  Sloth Drop
//
//  Created by Brian Doore on 11/6/14.
...
//        score += pointsEarned
        ...
        if removedLines.count == 1 {
            score += level * PointsPer1
        }
        
        if removedLines.count == 2 {
            score += level * PointsPer2
        }
        
        if removedLines.count == 3 {
            score += level * PointsPer3
        }
        
        if removedLines.count == 4 {
            score += level * PointsPer4
        }
